...
public class JdbcTimeEntryRepositoryTest {
    ...
    public void setUp() throws Exception {
       ...
       // dataSource.setUrl("jdbc:mysql://localhost:3306/tracker_test?user=tracker&useSSL=false&useTimezone=true&serverTimezone=UTC&useLegacyDatetimeCode=false&allowPublicKeyRetrieval=true");
